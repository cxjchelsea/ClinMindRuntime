# AI Implementation Skill：ClinMindRuntime（Phase 9-P0 已冻结）
...
> Phase 9-P0 已完成实现、测试、人工验证与冻结归档；后续只能做 bug fix、测试补强、文档修正，或进入 Phase 9-P1 / Phase 9-P2 / Phase 10 的新设计。
...
| 当前冻结记录 | `docs/3-phase实现/Phase9_P0冻结记录.md` |
| 当前实现目标 | Phase 9-P0 已完成；后续进入 Phase 9-P1 / Phase 9-P2 / Phase 10 |
...
7. `docs/3-phase实现/Phase9_P0人工测试结果.md`
8. `docs/3-phase实现/Phase9_P0冻结记录.md`
9. `docs/3-phase实现/Phase8_P2冻结记录.md`
10. `docs/3-phase实现/Phase8_P2人工测试结果.md`
11. `docs/3-phase实现/Phase8_P1冻结记录.md`
12. `docs/3-phase实现/Phase8_P0冻结记录.md`
13. Phase 1–7 各阶段冻结记录

---

# 三、当前允许做的事情

1. 对 Phase 9-P0 已冻结代码进行 bug fix、测试补强或文档修正。
2. 基于 Phase 9-P0 冻结记录准备 Phase 9-P1 / Phase 9-P2 / Phase 10 的设计文档。
3. 后续阶段可复用 ToolRegistryPolicy、McpServerRegistryPolicy、SkillRegistryPolicy、ToolInvocationPolicy。
4. 后续阶段可复用 mock/local ToolAdapter，但不得把 P0 mock 伪装为真实临床工具。
5. 后续阶段可复用 ToolInvocationRuntime 与 ToolResultValidationService。
6. 后续阶段可补强 Tool Governance Debug API 的测试或文档。
7. 后续阶段可补强 Tool Governance Evaluation Scorer 的测试或文档。
8. 后续阶段可补强 CandidateMappingPolicy 的测试或文档。
9. 后续阶段可补强 Trace / Audit 记录测试。
...
Phase 6–9 P0 已冻结能力只能被后续阶段复用，不能继续向已冻结范围堆新能力。
...
- `mvn test` 通过
- Phase 1–9 P0 既有 Runtime / Agent / Evidence / Graph / Provider / ModelGov / ToolGov / Evaluation / Candidate / Persistence / Console 测试不回归
